...
while True:
    ...
    if key == ord('s'):
        ...
        cv2.imwrite(f"{OUTPUT_DIR}/RESULTS/v05_resultBinary_0{img_count}.png", binary)
        cv2.imwrite(f"{OUTPUT_DIR}/RESULTS/v05_resultOutput_0{img_count}.png", frame_homography)
        img_count+=1
